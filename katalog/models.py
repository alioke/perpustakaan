...
class Book(models.Model):
    ...
    language = models.ForeignKey('Language', on_delete=models.SET_NULL, null=True, verbose_name='Bahasa')
    ...
    def display_genre(self):
        ...
        return ', '.join(genre.name for genre in self.genre.all()[:4]) #looping only 4
